...
<div class="page-content">
    <div class="page-header">
        <div class="container-fluid">
         <table class="table_deg" style="table-border-color-light: ">
             <tr>
             ...
             <tr>
                 ...
                 <td>
                     <a onclick="return confirm('Are you sure to delete this');" class="btn btn-warning" href="{{url('room_update',$data->id)}}">Update</a>
                 </td>
             </tr>
             @endforeach
         </table>
